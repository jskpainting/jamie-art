...
interface InquiriesClientProps {
  ...
  commissionStats: CommissionInquiriesStats
}
...
export function InquiriesClient({
  ...
  function handleEmail(inq: InquiryWithPainting) {
    window.location.href = buildPaintingReplyMailto(inq)
  ...
  const topTabs: { key: TopTab; label: string; count: number }[] = [
    { key: "painting", label: "Painting inquiries", count: inquiries.length },
    {
      key: "commission",
                      ...
                      <Fragment key={inq.id}>
                        ...
                        >
                          ...
                          <td className="px-4 py-3 hidden md:table-cell">
                            {inq.painting_title && inq.painting_section_slug ? (
                              <a
                                href={`/admin/portfolio/${inq.painting_section_slug}`}
                                target="_blank"
